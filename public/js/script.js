import Controller from "./controller.js";
   ...
   export class View { // What the app looks like, what the user can see and do, User Interface
        ...
        renderAsideGroups(title) {
          ...
          app.controller.returnUniqueGroupNames().map(group => {
            ...
            app.controller.returnUniqueCategoriesByGroup(group).map(category => this.renderAsideCatagory(category, group));
          })
            
        }
        renderAsideCatagory(category, group) {
          app.view.createElement("li", category, document.getElementById(`sidebar_${group}`))
        }
